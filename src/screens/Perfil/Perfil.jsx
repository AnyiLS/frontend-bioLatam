							...
							<div>
								<div className="container-cartas ">
									<div className="rounded-t-lg h-32 overflow-hidden">
										<img
											className="object-cover object-center w-[100px] pl-[12px] pt-[12px]"
                  ...
                  <div>{user.email}</div>
							...
							<div className="flex flex-col justify-center pl-[30px] vector only-mobile:pl-0 w-[90%] max-1366:w-full">
								...
								<StyledSlider
									slidesToShow={
										user &&
										user.complete_courses.length === 1
											? 1
											: user.complete_courses &&
											  user.complete_courses.length === 2
											? 2
											: 3
									}
									responsive={[
									...
									{user.complete_courses &&
										user.complete_courses.map(
											(item, index) => (
												<div
													className="group relative shadow-lg max-w-[280px] min-w-[280px] max-767:max-w-full"
													key={index}>
													<div className="aspect-h-1 aspect-w-1 w-full mx-auto overflow-hidden rounded-tl-[10px] rounded-tr-[10px] bg-white lg:aspect-none group-hover:opacity-75">
														<img
															src={
																item.course
																	.image_reference
													...
													<div className="p-4 flex justify-between bg-white">
														<div>
															<h3 className="text-xl text-[#00427f]">
																<a
																	href={`/cursos-forma/${item.course.slug}`}>
																	{
																		item
																			.course
																			.name
					...
					<button
						className="shadow-lg bg-red-500 rounded-[100%] fixed top-[90%] right-[20px] p-[15px]"
						onClick={logout}>
						<svg
							width={30}
							height={29}
