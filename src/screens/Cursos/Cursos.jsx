			...
			<div className="container-home">
				<div
					...
					style={{
						...
						backgroundImage:
							width > 767
								? `linear-gradient(90deg, rgba(242,242,242,1) 70%, rgba(253,187,45,0) 100%), url(${
										course ? course.image_reference : ''
								  })`
					...
					<div className="container flex flex-col justify-center h-full">
						...
						{!course && course.have_course && (
							<StyledAddButton
								onClick={() => addCourse(course.id, user.id)}>
								Adquiere este curso
							</StyledAddButton>
						)}
					</div>
			...
			<div className="container">
				<div className="bg-white">
					<nav className="tabs flex flex-col sm:flex-row">
						...
						{!course.name.toLowerCase().includes('vidas') && (
							<button
								data-target="panel-3"
				...
				<div id="panels">
					<div
						...
						<StyledSliderComments
							slidesToShow={
								course.comments && course.comments.length === 1
									? 1
									: course.comments &&
									  course.comments.length === 2
									? 2
									: 3
							}
							responsive={[
